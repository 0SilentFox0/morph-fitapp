...
export function ClientHomeScreen() {
  ...
  const { intensities, totals, weekTotals, streak, topMuscle } =
    React.useMemo(() => {
      const now = new Date();
  ...
  const myTrainer = React.useMemo(
    () => trainers.find((t) => t.connection !== 'none'),
    [trainers]
  );
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
        ...
        <FadeInUp delay={180}>
          ...
          <View style={styles.weekRow}>
            ...
            <WeekTile
              value={
                <AnimatedCounter style={styles.weekValue} value={streak} />
              }
              label="Streak"
            />
