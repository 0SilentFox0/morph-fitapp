...
export interface OnboardingScreenContext<R extends keyof OnboardingStackParamList> {
...
export function useOnboardingScreen<R extends keyof OnboardingStackParamList>(
  ...
  const navigation = useNavigation<NativeStackNavigationProp<OnboardingStackParamList, R>>();
