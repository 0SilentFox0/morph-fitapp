          ...
          <>
            ...
            <View style={styles.statsRow}>
              <View style={styles.statCard}>
                ...
                <Text style={styles.statValue}>{overview.completedTrainings}</Text>
            ...
            <Text style={styles.note}>
              Trainings, active clients and your clients' verified records grow your rank. Earnings are
              not counted.
            </Text>
...
const styles = StyleSheet.create({
  ...
  hero: { backgroundColor: colors.cardBg, borderRadius: radius.lg, padding: spacing.lg, alignItems: 'center', gap: spacing.xs },
  heroBadge: {
    width: 80,
    height: 80,
    borderRadius: 40,
  ...
  progressTrack: { width: '100%', height: 8, borderRadius: radius.pill, backgroundColor: colors.neutral3, overflow: 'hidden' },
  ...
  statCard: { flex: 1, backgroundColor: colors.cardBg, borderRadius: radius.md, paddingVertical: spacing.md, alignItems: 'center', gap: 2 },
