# Onboarding — Technical API Specification
...
>
> **Feature-level business logic, user stories, acceptance criteria, edge cases:** see [`features/onboarding.md`](features/onboarding.md).
...
- [`features/onboarding.md`](features/onboarding.md) — feature-level specs (user stories, acceptance criteria, edge cases).
