# External Integrations — Technical API Specification
...
>
> **Feature-level business logic, user stories, acceptance criteria, edge cases:** see [`features/integrations.md`](features/integrations.md).
...
- [`features/integrations.md`](features/integrations.md) — feature-level specs (user stories, acceptance criteria, edge cases).
