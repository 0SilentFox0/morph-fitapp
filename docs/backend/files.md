# Files & Media — Technical API Specification
...
>
> **Feature-level business logic, user stories, acceptance criteria, edge cases:** see [`features/files.md`](features/files.md).
...
- [`features/files.md`](features/files.md) — feature-level specs (user stories, acceptance criteria, edge cases).
