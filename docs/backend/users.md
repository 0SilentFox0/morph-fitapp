# Users & Profile — Technical API Specification
...
>
> **Feature-level business logic, user stories, acceptance criteria, edge cases:** see [`features/users.md`](features/users.md).
...
- [`features/users.md`](features/users.md) — feature-level specs (user stories, acceptance criteria, edge cases).
