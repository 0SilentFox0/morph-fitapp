# Workout Tracking — Technical API Specification
...
>
> **Feature-level business logic, user stories, acceptance criteria, edge cases:** see [`features/workout-tracking.md`](features/workout-tracking.md).
...
- [`features/workout-tracking.md`](features/workout-tracking.md) — feature-level specs (user stories, acceptance criteria, edge cases).
