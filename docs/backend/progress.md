# Progress Metrics — Technical API Specification
...
>
> **Feature-level business logic, user stories, acceptance criteria, edge cases:** see [`features/progress.md`](features/progress.md).
...
- [`features/progress.md`](features/progress.md) — feature-level specs (user stories, acceptance criteria, edge cases).
