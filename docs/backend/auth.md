# Auth & Identity — Technical API Specification
...
>
> **Feature-level business logic, user stories, acceptance criteria, edge cases:** see [`features/auth.md`](features/auth.md).
...
- [`features/auth.md`](features/auth.md) — feature-level specs (user stories, acceptance criteria, edge cases).
