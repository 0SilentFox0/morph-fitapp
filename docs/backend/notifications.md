# Notifications — Technical API Specification
...
>
> **Feature-level business logic, user stories, acceptance criteria, edge cases:** see [`features/notifications.md`](features/notifications.md).
...
- [`features/notifications.md`](features/notifications.md) — feature-level specs (user stories, acceptance criteria, edge cases).
