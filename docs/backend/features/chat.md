...
- API: [`../chat.md`](../chat.md) § `GET /conversations`, `POST /conversations`, `GET /conversations/{id}`, `DELETE /conversations/{id}`
...
- API: [`../chat.md`](../chat.md) § `POST /conversations/{id}/messages`, `GET /conversations/{id}/messages?cursor=&since=`, `DELETE /messages/{id}`
...
- API: [`../chat.md`](../chat.md) § `POST /conversations/{id}/mark-read`, WS channel client events (`client-typing`)
