...
**Модуль:** Users & Profile · **Phase:** 0 · **Файлів-сусідів:** [`../user.md`](../user.md) (technical), [`../DB_STRUCTURE.md`](../DB_STRUCTURE.md)
...
- API: [`../user.md`](../user.md) § `GET /me`, `PATCH /me`, `GET /users/{id}`, `POST /me/avatar`, `PATCH /me/settings`
